The application has been implemented using **_reactjs,react-redux ,materail ui_** . All code are in **_src_** directory .The folder structure inside **_src_** as below
## Directory structure:
- action-types
- actions
- assets/
