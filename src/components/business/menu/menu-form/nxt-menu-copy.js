      ...
      <form onSubmit={handleSubmit} className={classes.name}>
        ...
        <Box p={1}>
          <Typography variant="caption" display="block" gutterBottom style={{ 'font-size': '10px' }} >
            This will create a new instance of the the selected company menu along with all it’s menu items in the current store. You
            can then go in and Edit/Delete individual menu items or the menu itself as you need.
            After beeing copied, any updates made in the company level for it will not effect this menu or any of it’s menu items.
            </Typography>
        </Box>
...
MenuCopyForm = reduxForm({
  form: 'MenuCopyForm', // a unique identifier for this form
